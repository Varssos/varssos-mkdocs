...
- [Generate ssh keys - ssh academy](https://www.ssh.com/academy/ssh/keygen)
- [How to generate ssh keys on ubuntu](https://phoenixnap.com/kb/generate-setup-ssh-key-ubuntu)
