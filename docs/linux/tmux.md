...
[How to configure tmux, Dreams of Code](https://www.youtube.com/watch?v=DzNmUNvnB04)
...
Example of creating a tmux session with two windows:
```bash
...
```
3. On next reboot it should create the tmux session on startup
