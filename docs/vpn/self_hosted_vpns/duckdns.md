...
!!! warning
    If you want to make it available outside you local network and you use vpns like tailscale set your external IP: 100... instead of 192. In that case you will be able to access from you mobile phone if you use gsm.
