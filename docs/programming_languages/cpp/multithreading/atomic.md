...
[Atomic theoretical knowledge](https://infotraining.bitbucket.io/cpp-thd/atomic.html)

[std::atomic cppreference](https://en.cppreference.com/w/cpp/atomic/atomic)

!!! important
    Add flag `-latomic` when you compile

!!! warning
    1. There is no atomic multiplicaiton like `x*=2`
