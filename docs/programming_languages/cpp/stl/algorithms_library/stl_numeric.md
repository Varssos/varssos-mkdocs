...
[cpp reference \<numeric\>](https://en.cppreference.com/w/cpp/header/numeric)
...
- `T reduce( InputIt first, InputIt last, T init )` Like accumulate, but out of order. Quicker in parallel execution
