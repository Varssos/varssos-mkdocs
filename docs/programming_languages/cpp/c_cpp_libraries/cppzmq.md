...
!!! warning
    Pay attention on disconnect. Try socket disconnect and avoid context close when you want to reconnect again
...
[Socket types](http://api.zeromq.org/master:zmq-socket)
