...
[Gynvael about process memory](https://www.youtube.com/watch?v=MM4hDpzFUcA&t=9223s)

## C/C++ memory segments

![C/C++ memory layout](./cpp_memory_layout.png)
...
![C/C++ RAM memory](./cpp_ram_memory.png)
...
!!! important
    Why memory allocatin on the heap is slower?
...
!!! important
    1. When stack collide with heap. It is stack clash
...
[Stack overflow about /proc/$PID/maps](https://stackoverflow.com/questions/1401359/understanding-linux-proc-pid-maps-or-proc-self-maps)
