...
[C++ cmake gtest template project](https://github.com/Varssos/Cpp_CMake_GTest_Template)
...
It should works as [here](https://www.youtube.com/watch?v=3zUqJEilhnM)
but on windows even with installed posix mingw packages, there was problem
with \<thread\>. It had to be declared as \<pthread.h\>

1. First install cmake like it is described in the CMake setup guide
