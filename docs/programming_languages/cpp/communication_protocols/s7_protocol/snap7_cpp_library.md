...
Source repository for snap7 is [on sourceforge](http://snap7.sourceforge.net/)

I created my own [mirror for snap7 on github](https://github.com/sebastianwach/snap7)
...
![Siemens data format](./siemens_data_format.png)

!!! important
    In case of problems with endian convention, you can use `be64toh()` etc.

## Target compatibility

![Snap7 compatibility](./snap7_compatibility.png)
...
![Optimized block access](./optimized_block_access.png)

3. Set `Full access(no protection)` and `Connection mechanisms ( Permit access with PUT/GET...)`

!!! important
    In case of activating OPC UA server, communication with S7 protocol probably will not work

![PLC full access](./plc_full_access.png)
