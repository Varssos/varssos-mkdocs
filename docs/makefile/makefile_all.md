...
All knowledge about GNU Makefile [link](https://www.gnu.org/software/make/manual/html_node/index.html#SEC_Contents)
...
!!! important
    It will take last declaration of `Y` before invoking `MAKE_DEPEND`
...
Setting of a variable with simple expansion of the values inside - values within it are expanded at declaration time. Example
...
[Well described article](https://www.gnu.org/software/make/manual/html_node/Phony-Targets.html#Phony-Targets)
...
All knowledge about function is [here](https://www.gnu.org/software/make/manual/html_node/Functions.html#Functions)
...
!!! important
    Commas and unmatched parentheses or braces cannot appear in the text of an argument as written. It can be done in this way:
...
Returns all whitespace-separated words in text that do match any of the pattern words, removing any words that do not match. Example:
...
It works exactly opposite to `filter`. Example:
