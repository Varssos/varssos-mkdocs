# Makefile tips, knowledge in a nutshell
...
[Cool, more complex makefile example](https://riptutorial.com/makefile/example/21376/building-from-different-source-folders-to-different-target-folders)

!!! note
    1. typing `make` means: build the first rule in the makefile
    2. To write prerequisites, recipes in multiple lines `\` on the end of line is used
...
![Project structure](./proj_structure.png)
