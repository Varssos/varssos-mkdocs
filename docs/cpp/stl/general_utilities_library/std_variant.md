...
It was introduced in C++17 as an alternative to the unsafe union.

[std::variant cppreference](https://en.cppreference.com/w/cpp/utility/variant)

[Infotraining C++17 variant](https://infotraining.bitbucket.io/cpp-17/variant.html)
...
!!! important
    In case of no value or bad type it throws `std::bad_variant_access`
