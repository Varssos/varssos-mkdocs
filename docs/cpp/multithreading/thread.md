...
!!! important
    Double join will cause program termination
...
!!! important
    If you do not use `join()` or `detached()` it will cause `Aborted (core dumped)`
...
!!! important
    Condition Variable are used for two purposes:
